      ...
      >
        ...
        >
          ...
          >
            <Avatar
              variant="square"
              src={`${host}/uploads/company/${company?.profile}`}
            />
            <Box>
              <Typography
        ...
        <List sx={{ backgroundColor: "" }}>
          {navOptions.map((text, index) => (
            ...
            >
              <ListItemButton
                sx={{
                  backgroundColor: activeNavOption == text.path && "#ff8e29",
                  borderRadius: activeNavOption == text.path ? "10px" : "0px",
                  display: "flex",
              ...
              >
                <ListItemIcon
                  sx={{
                    color: activeNavOption == text.path ? "white" : "#ff8e29",
                    p: 1,
                  }}
                >
                  {text.icon}
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography
                      sx={{
                        fontWeight: "bolder",
                        color: activeNavOption == text.path ? "white" : "black",
                        fontSize: "13px",
                      }}
                    >
                      {text.title}
